...
<head>
    ...
    <link href="files/reset/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/reset/data.js"></script>
    ...
    <div id="base" class="">
      ...
      <div id="u573" class="ax_default box_2">
        ...
        <div id="u574" class="text" style="visibility: visible;">
          <p><span>欢迎来到E.D Market重设密码界面</span></p>
        </div>
      </div>
      ...
      <!-- Unnamed (文本框) -->
      <div id="u582" class="ax_default text_field">
        <input id="u582_input" type="text" value=""/>
      </div>
    </div>
  </body>
</html>
