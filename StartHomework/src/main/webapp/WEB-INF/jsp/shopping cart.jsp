...
<html>
  <head>
    ...
    <link href="files/购物车/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/购物车/data.js"></script>
  ...
  <body>
    <div id="base" class="">
      ...
      <div id="u130" class="ax_default line">
        <img id="u130_img" class="img " src="images/购物车/u130.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u132" class="ax_default image">
        <img id="u132_img" class="img " src="images/购物车/u132.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u146" class="ax_default text_field">
        <input id="u146_input" type="text" value="0"/>
      </div>
      ...
      <div id="u149" class="ax_default _一级标题">
        ...
        <div id="u150" class="text" style="visibility: visible;">
          <p><span>ED Market</span></p>
        </div>
      </div>

      <!-- Unnamed (文本框) -->
      <div id="u151" class="ax_default text_field">
        <input id="u151_input" type="text" value="为了您的账号安全，请勿将密码透露于他人，祝您购物愉快！"/>
      </div>
    </div>
  </body>
</html>
